...
def build_solution_doc():
    ...
    doc.add_heading("7. 全产业链系统孤岛贯通", level=1)
    para(
        doc,
    ...
    doc.add_heading("8. 产供销经济取舍口径", level=1)
    para(
        doc,
    ...
    doc.add_heading("9. 跨装置联动的调度优先级", level=1)
    para(
        doc,
    ...
    doc.add_heading("10. 30/60/90天落地路径", level=1)
    table(
        doc,
        ["阶段", "目标", "交付物", "验收口径"],
        [
    ...
    doc.add_heading("11. 验收与停用条件", level=1)
    bullets(
        doc,
        [
